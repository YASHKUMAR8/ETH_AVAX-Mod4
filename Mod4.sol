...
contract DengenToken is ERC20, Ownable {
    ...
    function burntoken(uint256 amount) public {
      ...
      function redeemtoken(string memory itemName, uint256 amount) public {
     ...
     function togetRedeemedItems(address account) public view returns (RedeemedItem[] memory) {
        require(account != address(0), "Query for zero address");
        return redeemedItems[account];
    }


        function toprintRedeemedTokens(address account) public view returns (string memory) {
        require(account != address(0), "Query for zero address");
   ...
   function check_Balance(address account) public view returns (uint256) {
    ...
    function to_transferTokens(address from, address to, uint256 amount) public {
